...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "Dinar Aulliyah Balqis",
            BATCH_ACADEMY = "Theia Night Online",
            GITHUB_REPO_LINK = "https://github.com/dinaraulliyah/capstone-DA-telebot"
        )
...
#         # TO DO: prepare data for visualization
         ...
         df_plot = df_campaign.iloc[:, [3,10,12]].groupby("age").sum()
...
#     # TO DO: emoji
     with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
         ...
         default = temp.substitute(EMOJI = emoji.emojize(':smiling_face_with_tear:'))
